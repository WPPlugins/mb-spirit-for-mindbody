...
define('MB_SPIRIT_VERSION', '1.0.14');
	...
	class mb_spirit {
		...
		*/
		...
		public function init_scripts() {
			if (is_admin()) {
				wp_enqueue_script( $this->plugin_id, plugins_url('/js/admin.js', __FILE__), array( 'jquery' ), MB_SPIRIT_VERSION, true );
		...
		public function admin_menu() {
			...
			add_menu_page( __('MB Spirit', $this->plugin_id ), __("MB Spirit", $this->plugin_id ), 'manage_options', $menuid, array( $this, 'show_overview_page' ), null, 8 );
...
if ( ! class_exists( 'mb_spirit_widget' ) ) {
	...
	add_action(
		'widgets_init',
		create_function('','return register_widget("mb_spirit_widget");')
	);
}
